...
//mySQL
	$insert_query = "INSERT INTO assignment4_1(word1, word2, word3, word4, word5, word6, word7, word8, word9, word10, word11, word12, word13) VALUES ('".$_POST['form1']."', '".$_POST['form2']."', '".$_POST['form3']."', '".$_POST['form4']."', '".$_POST['form5']."', '".$_POST['form6']."', '".$_POST['form7']."', '".$_POST['form8']."', '".$_POST['form9']."', '".$_POST['form10']."', '".$_POST['form11']."', '".$_POST['form12']."', '".$_POST['form13']."')";
...
/*	if(isset($_POST['form1'])) {
	...
	print '<title>Validate for Redirect</title>';
